...
<div class="m-t-sm line-hi32">
    ...
    <div class="control-grouptwo">
        ...
        <div class="controls" id="submitInfo">
            ...
            <soul:button target="${root}/fund/userBankcard/submitBtc.html" post="getCurrentFormData" dataType="json" callback="saveBankcardCallback" text="确认" opType="ajax" precall="validateForm" cssClass="btn btn-blue middle-big btn-bank"/>
        </div>
    </div>
</div>