...
<form name="addBankForm">
    <input type="hidden" name="bankId" value="${bankcard.id}">
    <gb:token/>
    <div class="notice">
        ...
        <div class="m-t-sm line-hi32">
            ...
            <div class="control-grouptwo">
                ...
                <div class="controls" id="submitInfo">
                    ...
                    <soul:button precall="validateForm" target="submitBankCard" text="${views.fund_auto['确认']}" opType="function" cssClass="btn btn-blue middle-big btn-bank"/>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a style="display: none" name="returnMain" nav-target="mainFrame" href="/personInfo/index.html"></a>
                        </c:otherwise>
                    </c:choose>
