...
import so.wwb.gamebox.pcenter.fund.controller.PlayerTransferController;
...
//endregion your codes 1
    ...
    @Comment("转入")
    @NotBlank(message = "fund.transferForm.transferIntoNotBlank")
    ...
    @Comment("转出")
    @NotBlank(message = "fund.transferForm.transferOutNotBlank")
    ...
    @Remote(message = "fund.transferForm.transferAmountCheck", checkClass = PlayerTransferController.class, checkMethod = "checkTransferAmount", additionalProperties = {"transferOut"})
