...
<form:form>
    ...
    <div id="realName1">
        ...
        <div class="modal-footer">
            <soul:button precall="validateForm" title="ok" target="${root}/accountSettings/updateRealName.html" text="${views.common['ok']}" opType="ajax" cssClass="btn btn-blue middle-big"  post="getCurrentFormData" callback="closeRealNameDialog" />
...
<soul:import res="site/accountManagement/SettingRealName"/>
