        ...
        <form id="bindBtcForm">
            ...
            <div class="control-grouptwo">
                ...
                <div class="controls" id="submitInfo">
                    <soul:button target="reset" text="重置" opType="function" cssClass="btn btn-gray middle-big"/>
                    <a title="重置" class="btn btn-gray middle-big">
                        重置
                    </a>
                    <soul:button target="confirm" text="确认" opType="dialog" cssClass="btn btn-blue middle-big btn-bank"/>
                </div>
            </div>
        </form>
    </div>
