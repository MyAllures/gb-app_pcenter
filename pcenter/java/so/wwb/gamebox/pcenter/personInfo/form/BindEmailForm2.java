 ...
 */
@Comment("绑定邮箱第二步弹窗弹窗")
public class BindEmailForm2 implements IForm {
...
//    @Remote(checkClass = PersonalInfoController.class, checkMethod = "verifyEmail2", additionalProperties = {"email_contactValue"}, message = "邮箱错误")
    @Comment("邮箱")
